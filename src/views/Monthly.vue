<template>
  <div class="home-container">
    <div class="home-content">
      ...
      <el-table :data="period" fit border style="" :show-header="false">
        <el-table-column prop="dateFormat" width="110"> </el-table-column>
        <el-table-column prop="courts" width="100"> </el-table-column>
      </el-table>
    </div>
  </div>
</template>
    ...
    async getPeriod(date) {
      ...
      res.forEach((element) => {
        ...
        element.orderMsg.courts.forEach((court) => {
          period[index].courts.push(court.number);
        });
